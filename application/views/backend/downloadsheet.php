...
<html>
    ...
    ?>
        <div class="dl1">
                    ...
                    <td colspan="2">
                        <table class="dl3">
                            <tr>
                                ...
                                <td class="dl6"></td>
                                <td class="dl7">
                                    <p class="dl8"><b>Cộng Hòa Xã Hội Chủ Nghĩa Việt Nam</b></p>
                                    <p class="dl9">Độc lập - Tự do - Hạnh phúc</b></p>
                                    <p class="dl9">Phiếu thông tin học sinh</p>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <small class="dl16"><?php echo html_entity_decode($this->db->get_where('academic_settings', array('type' => 'terms'))->row()->description); ?></small>
            <br>
            <table cellpadding="0" cellspacing="0" class="dl17">
                <tr>
                    <td class="dl18">
                        <center>____________________________________<br>
                        <?php echo getEduAppGTLang('parent');?> kí tên
                    </td>
                    <td colspan="1" class="dl19">
                    </td>
                    <td class="dl18">
                        ____________________________________<br><?php echo getEduAppGTLang('student');?> kí tên
                    </td>
                    </td>
                </tr>
            </table>
