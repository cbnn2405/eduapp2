            					...
            					<div class="info-2">
            						<div class="rcard-profile">
              						...
              						<div class="company-address">
                						<?php echo getEduAppGTLang('roll');?>: <?php echo $this->db->get_where('enroll', array('student_id' => $student_id))->row()->roll;?><br/>
                						<?php echo getEduAppGTLang('class');?>: <?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?><br/>
                						<?php echo getEduAppGTLang('class');?>: <?php echo $this->db->get_where('section' , array('class_id' => $class_id))->row()->name;?>
              						</div>
            					</div>
          					</div>
