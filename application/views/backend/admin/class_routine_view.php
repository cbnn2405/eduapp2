                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane <?php if($row['name'] == 'A') echo 'active';?>" id="<?php echo $row['name'];?>">
                        <div class="element-wrapper">
                            <div class="element-box table-responsive lined-primary shadow" id="print_area<?php echo $row['section_id'];?>">
                                <div class="row m-b">
                                    <div class="show-inline">
                                        <img class="logo-section" src="<?php echo base_url();?>public/uploads/<?php echo $this->crud->getInfo('logo');?>"/>    
                                    </div>
                                    <div class="routine">
                                ...
                                ?>
                                    <tr>
                                        <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                            <td width="120" class="bg-primary text-black text-center" height="100">
                                            ...
                                            <td class="text-center">
                                                <div class="pi-controls text-right">
                            ...
                            <button class="btn btn-rounded btn-primary pull-right" onclick="Print('print_area<?php echo $row['section_id'];?>')" ><?php echo getEduAppGTLang('print');?></button><br><br><br>
                        </div>  
                    </div>
                    <?php endforeach;?>
                    <?php endif;?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('add_schedules');?> </h6>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        ...
                                        <div class="select">
                                            <select name="section_id" id="section_holder" onchange="get_class_subjects(this.value);" required="">
                                                <option value=""><?php echo getEduAppGTLang('select');?></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        ...
                                        <div class="select">
                                            <select name="subject_id" id="subject_holder" required="">
                                                <option value=""><?php echo getEduAppGTLang('select');?></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12"><legend><span class="px15"><?php echo getEduAppGTLang('start');?></span></legend></div>
                                ...
                                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        <label class="control-label"><?php echo getEduAppGTLang('sandbox_mode');?></label>
                                        <div class="select">
                                ...
                                <div class="col-sm-12"><legend><span class="px15"><?php echo getEduAppGTLang('end');?></span></legend></div>
                                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        <label class="control-label"><?php echo getEduAppGTLang('hour');?></label>
                                        <div class="select">
