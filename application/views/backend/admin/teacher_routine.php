            ...
            <div class="content-box">
                ...
                <?php if($teacher_id > 0):?>
                    <div class="element-wrapper">
                        <div class="element-box table-responsive lined-primary shadow" id="print_area">
                            <div>
                                <center> 
                                    ...
                                    <img class="mheight" src="<?php echo $this->crud->get_image_url('teacher', $teacher_id);?>" alt=""/>   
                            ...
                            ?>
                                <tr>
                                    <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                        <td width="120" class="bg-primary text-black text-center" height="90"><strong><?php echo ucwords(getEduAppGTLang($day));?></strong></td>
                                        <?php
                                        ...
                                        ?>
                                        <td class="text-center"><?php echo $row2['time_start'].':'.$row2['time_start_min']." <b>".$row2['amstart']."</b>".' - '.$row2['time_end'].':'.$row2['time_end_min']." <b>".$row2['amend']."</b>";?>
                        ...
                        <button class="btn btn-rounded btn-primary pull-right" onclick="Print('print_area')" ><?php echo getEduAppGTLang('print');?></button><br><br><br>
                    </div>  
                <?php endif;?>
                </div>      
            </div>
