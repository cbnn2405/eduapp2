                        ...
                        <div class="element-box table-responsive lined-primary shadow" id="print_area">
                            <div class="row m-b">
                                <div class="show-inline">
                                    <img class="logo-section" src="<?php echo base_url();?>public/uploads/<?php echo $this->crud->getInfo('logo');?>" alt=""/>    
                                </div>
                                <div class="routine">
                            ...
                            ?>
                                <tr>
                                    <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                        <td width="120" height="90" class="text-center bg-primary text-black"><strong> <?php echo ucwords(getEduAppGTLang($day));?></strong></td>
                                        <?php
