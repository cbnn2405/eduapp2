                            ...
                            <div class="element-box table-responsive lined-primary shadow" id="print_area">
			                    <div class="row m-b">
				                    <div class="show-inline">
				                        <img class="mhroutine" src="<?php echo $this->crud->get_image_url('teacher', $this->session->userdata('login_user_id'));?>" alt=""/>		
				                    </div>
				                    <div class="routine">
    			                ...
    			                ?>
			                        <tr>
				                        <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
					                        <td width="120" height="90" class="text-center bg-primary text-black"><strong> <?php echo getEduAppGTLang($day);?></strong></td>
					                        <?php
