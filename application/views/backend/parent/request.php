            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links active" data-toggle="tab" href="#permissions"><i class="os-icon picons-thin-icon-thin-0015_fountain_pen"></i><span><?php echo getEduAppGTLang('all_permissions');?></span></a>
                        </li>
                        <li class="nav-item">
                            <a class="navs-links" data-toggle="tab" href="#apply"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><span><?php echo getEduAppGTLang('permissions');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="elem ent-box lined-primary shad ow">
	                                <div class="table-responsive">
		                                <table class="table table-padded">
                                        	...
                                        	?>   
                            				    <tr>
                                					<td><a class="btn nc btn-rounded btn-sm btn-purple text-white"><?php echo $row['title']; ?></a></td>
                            					    <td><?php echo $row['description']; ?></td>
                            					    <td><img alt="" src="<?php echo $this->crud->get_image_url('student', $row['student_id']);?>" width="25px" class="tbl-user"> <?php echo $this->crud->get_name('student', $row['student_id']) ?></td>
                            					    <td><a class="btn nc btn-rounded btn-sm btn-primary text-white"><?php echo $row['start_date']; ?></a></td>
                            					    <td><a class="btn nc btn-rounded btn-sm btn-secondary text-white"><?php echo $row['end_date']; ?></a></td>
                            					    <td>
                            					    <?php if($row['status'] == 0): ?>
                                						<a class="btn nc btn-rounded btn-sm btn-warning text-white"><?php echo getEduAppGTLang('pending');?></a>
                            					    <?php endif;?>
                            					    <?php if($row['status'] == 1): ?>
                                						<a class="btn nc btn-rounded btn-sm btn-success text-white"><?php echo getEduAppGTLang('approved');?></a>
                            					    <?php endif;?>
                            					    <?php if($row['status'] == 2): ?>
                                						<a class="btn nc btn-rounded btn-sm btn-danger text-white"><?php echo getEduAppGTLang('rejected');?></a>
                            					    <?php endif;?>
                            					    </td>
                            				    </tr>
                            				    <?php } ?>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box lined-primary shadow">
			                            <?php echo form_open(base_url() . 'parents/request/create' , array('enctype' => 'multipart/form-data'));?>
			                                <h5 class="form-header"><?php echo getEduAppGTLang('permissions');?></h5><br>
