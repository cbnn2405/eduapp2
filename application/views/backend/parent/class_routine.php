                ...
                <?php $active = $n++;?>
                        <div class="tab-pane <?php if($active == 1) echo 'active';?>" id="<?php echo $row2['username'];?>">
                            <div class="element-wrapper">
                                    ...
                                    ?>
                                        <tr>
                                            <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                                <td width="120" class="bg-primary text-black" height="100"><?php echo getEduAppGTLang($day);?></td>
                                                <?php
                                ...
                                <button class="btn btn-rounded btn-success pull-right" onclick="Print('print_area<?php echo $row2['student_id'];?>')" ><?php echo getEduAppGTLang('print');?></button><br><br><br>
                            </div>
                        </div>  
                    <?php endforeach;?>
                    </div>
